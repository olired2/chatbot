            ...
            <div className="flex">
              ...
              <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                {session?.user.role === 'Maestro' ? (
                  <>
                    <Link href="/dashboard/classes" className="text-gray-800 font-medium inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-indigo-500 hover:text-indigo-600 transition-colors">
                      📚 Mis Clases
                    </Link>
                    <Link href="/dashboard/emails" className="text-gray-800 font-medium inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-indigo-500 hover:text-indigo-600 transition-colors">
                      📧 Correos Motivacionales
                    </Link>
                  </>
                ) : (
                  <>
                    <Link href="/dashboard/chat" className="text-gray-800 font-medium inline-flex items-center px-1 pt-1 border-b-2 border-transparent hover:border-indigo-500 hover:text-indigo-600 transition-colors">
                      💬 Chat con Mentor
                    </Link>
                  </>
                )}
