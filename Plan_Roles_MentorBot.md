...
### 🛡️ Permisos y Accesos
* **Gestión de Clases:** Permiso absoluto (Crear, Leer, Actualizar, Borrar) **solo sobre las clases que él mismo ha creado**. No tiene acceso a las clases de otros maestros.
...
* **Retención Escolar (Panel de Correos):** Usar el panel de correos motivacionales para detectar qué estudiantes llevan más de 15 días inactivos y enviar alertas masivas o individuales para evitar la deserción.
...
* **Interacción Controlada:** Puede conversar con MentorBot, pero sus comandos de IA están confinados en un entorno aislado (solo puede hablar sobre el temario).
...
* **Asistencia:** Mantenerse activo en la plataforma para evitar activar los disparadores de inactividad que alertan al profesor.
